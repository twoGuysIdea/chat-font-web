...
;layui.define(["layer", "laytpl", "upload"], function(i) {
    ...
    var x, b, w, k, C, S = function(i, a, n) {
        ...
        if (a[0]) {
            ...
            1 !== s.find("li").length || o[0] || (r || w.css("width", 800),
                s.css({
                    height: w.height()
                }).show(),
        ...
        if (a) {
            ...
            return 1 === u && (w.find(".layim-chat-list").hide(),
            c || w.css("width", "600px"),
    ...
    }, $ = "layui-anim-loop layer-anim-05", F = function(i) {
        ...
        tab: function(i) {
            ...
            "number" == typeof i ? (a = i,
                i = t.eq(a)) : a = i.index(),
                a > 2 ? t.removeClass(o) : (ei.tab.index = a,
                    i.addClass(o).siblings().removeClass(o)),
                ...
                if ("" === a)
                    ...
                    for (var n = [], l = j.friend || [], s = j.group || [], o = "", r = 0; r < l.length; r++)
                        for (var d = 0; d < (l[r].list || []).length; d++)
                            l[r].list[d].username.indexOf(a) !== -1 && (l[r].list[d].type = "friend",
                                l[r].list[d].index = r,
                                l[r].list[d].list = d,
                                n.push(l[r].list[d]));
        ...
        groupMembers: function(i, a) {
            ...
            i.data("down") ? l() : (n.html("&#xe619;"),
                i.data("down", !0),
                ei.groupMembers.index = t.tips('<ul class="layim-members-list"></ul>', i, {
                    tips: 3,
                    time: 0,
                    anim: 5,
                    fixed: !0,
            ...
            layui.upload({
                ...
                success: function(i) {
                    0 == i.code ? (i.data = i.data || {},
                        "images" === a ? ii(n.textarea[0], "img[" + (i.data.src || "") + "]") : "file" === a && ii(n.textarea[0], "file(" + (i.data.src || "") + ")[" + (i.data.name || "下载文件") + "]"),
                        D()) : t.msg(i.msg || "上传失败")
                }
            })
        },
        ...
        chatLog: function(i) {
            var a = O();
            return j.base.chatLog ? (t.close(ei.chatLog.index),
                ei.chatLog.index = t.open({
                    type: 2,
                    maxmin: !0,
